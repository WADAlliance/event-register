...
const stakeholderTypes = [
  ...
  { name: 'Participants Francophone', id: '3jO8YE', description: 'Individus', video: '/videos/cats_dinner.mp4', extraInfo: "Les participants sont tous des individus, y compris les développeurs, les artistes, les agriculteurs, les leaders communautaires, ainsi que toute personne souhaitant expérimenter ou innover sur des systèmes locaux.", disabled: false },
];
