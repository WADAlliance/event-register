...
const stakeholderTypes = [
  { name: 'Participants', id: 'mD627j', description: 'Individuals', video: '/videos/cats_dinner.mp4', extraInfo: "This is some example text.", disabled: false },
  { name: 'Communities of Place', id: 'w4NK1O', description: 'Regional hubs and locals', video: '/videos/boat_selfie.mp4', extraInfo: "# Place\nPlace is like where you're from innit.", disabled: false },
