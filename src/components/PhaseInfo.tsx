            ...
            {phaseInfo ? (
                <div className="text-sm text-gray-400 flex flex-col items-center">
                    <div className="flex items-center">
                        <span className="text-gray-100 font-semibold text-right text-xs md:text-base">{phaseInfo.name}</span>
                    ...
                    <p className="text-xs md:text-base text-wada-a mt-1 text-center">{phaseInfo.purpose}</p>
                </div>
            ) : (
