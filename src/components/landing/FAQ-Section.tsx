        ...
        return (
            ...
            >
                ...
                <div className="w-full max-w-7xl mx-auto px-8 md:px-16 lg:px-24" style={{ position: "relative", zIndex: 1 }}>
                    <h2 className="text-center text-4xl md:text-5xl font-black mb-12 text-black">Frequently Asked Questions</h2>
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between px-6 md:px-8 py-4 md:py-4 w-full" style={isOpen ? { backgroundColor: "#E85625" } : { backgroundColor: "#FFFFFF" }}>
                                        <button
                                            ...
                                            className={`text-left flex-1 focus:outline-none transition-colors ${
                                                isOpen ? "text-white font-bold text-lg md:text-xl" : "text-black font-bold text-base md:text-lg"
                                            }`}
                                        >
                                            <span className="inline-block mr-3">{`${idx + 1}.`}</span>
                                            {item.question}
                                        </button>
                                    ...
                                    >
                                        <div className="px-6 md:px-8 py-2 md:py-2 bg-[#E85625] w-full">
                                            {item.answer ? (
                                                <p className="text-white text-base md:text-lg leading-relaxed">{item.answer}</p>
                                            ) : (
                                                <p className="text-white/70 text-base md:text-lg leading-relaxed italic">(Content to be added)</p>
                                            )}
                                        </div>
