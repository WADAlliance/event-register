                ...
                <div className="flex flex-col justify-start items-center gap-3.5">
                    <div className="inline-flex flex-wrap justify-center items-center">
                        <div className="px-2.5 py-[5px] flex justify-center items-center gap-2.5">
                            <h1 className="text-center justify-start text-black text-2xl sm:text-3xl lg:text-4xl">Summit</h1>
                        </div>
                        <div className="px-2.5 py-[5px] bg-wada-c flex justify-center items-center gap-2.5">
                            <h1 className="text-center justify-start text-white text-2xl sm:text-3xl lg:text-4xl">Venues</h1>
                        </div>
                    </div>
                    <div className="w-full max-w-[566px] px-2.5 inline-flex justify-center items-center gap-2.5">
                        <p className="flex-1 text-center justify-start text-black text-sm sm:text-base leading-6 sm:leading-7">A three-day journey from innovation to collaboration.</p>
                    </div>
                </div>
                <div className="w-full inline-flex flex-col lg:flex-row justify-center items-stretch gap-4 lg:gap-2.5">
                    <div data-property-1="hover" className="group w-full lg:w-1/2 p-4 sm:p-6 lg:p-7 bg-white hover:bg-black rounded-[10px] outline outline-1 outline-offset-[-1px] outline-white/20 inline-flex flex-col justify-start items-start gap-2.5 transition-colors duration-300">
                        <div className="self-stretch flex flex-col sm:flex-row justify-center sm:justify-start items-center sm:items-start gap-3">
                            ...
                            <div className="flex-1 inline-flex flex-col justify-start items-center sm:items-end">
                                <div className="px-2.5 inline-flex justify-center items-center gap-2.5">
                                    <h3 className="text-center justify-start text-black group-hover:text-white text-lg sm:text-xl leading-6 sm:leading-7 transition-colors duration-300">11th - 12th Feb 2026</h3>
                                </div>
                                <div className="self-stretch px-2.5 inline-flex justify-center sm:justify-end items-center gap-2.5">
                                    <p className="flex-1 text-center sm:text-right justify-start text-black group-hover:text-white text-sm sm:text-base leading-6 sm:leading-7 transition-colors duration-300">2 days In-person</p>
                                </div>
                            </div>
                        </div>
                        <h3 className="w-full text-center text-black group-hover:text-white transition-colors duration-300 text-[clamp(1.5rem,4vw,2.5rem)] sm:text-3xl lg:text-[27px] lg:leading-[39px] lg:tracking-[0px] lg:text-left whitespace-nowrap">
                            Build. Ship. Complete
                        </h3>
                        <p className="self-stretch text-center sm:text-left justify-start text-black group-hover:text-white text-sm sm:text-base leading-6 sm:leading-7 transition-colors duration-300">
                        ...
                        <div className="self-stretch flex flex-col justify-start items-start gap-5">
                            ...
                            <div className="self-stretch flex flex-col sm:flex-row justify-center items-center gap-3 mt-auto">
                                <div className="flex-1 inline-flex flex-col justify-center items-center text-center max-w-160 pt-5">
                                    <div className="px-2.5 inline-flex justify-center items-center gap-2.5">
                                        <h4 className="text-center text-black group-hover:text-white text-base sm:text-lg leading-5 sm:leading-6 transition-colors duration-300">Open to developers and professionals</h4>
                                    </div>
                                    <div className="self-stretch px-2.5 inline-flex justify-center items-center gap-2.5">
                                        <p className="text-center text-black group-hover:text-white text-xs sm:text-sm leading-6 sm:leading-7 transition-colors duration-300">Prizes, mentorship & incubation opportunities</p>
                                    </div>
                                </div>
                    ...
                    <div data-property-1="Default" className="group w-full lg:w-1/2 p-4 sm:p-6 lg:p-7 bg-white hover:bg-black rounded-[10px] outline outline-1 outline-offset-[-1px] outline-white/20 inline-flex flex-col justify-start items-start gap-2.5 transition-colors duration-300">
                        <div className="self-stretch flex flex-col sm:flex-row justify-center sm:justify-start items-center sm:items-start gap-3">
                            <div className="px-4 sm:px-5 py-2.5 sm:py-3.5 bg-cardano-c rounded-[32px] flex justify-center items-center gap-2.5">
                                <div className="text-center text-white text-sm sm:text-base">Main Summit</div>
                            </div>
                            <div className="flex-1 inline-flex flex-col justify-start items-center sm:items-end">
                                <div className="px-2.5 inline-flex justify-center items-center gap-2.5">
                                    <h3 className="text-center justify-start text-black group-hover:text-white text-lg sm:text-xl leading-6 sm:leading-7 transition-colors duration-300">13 Feb 2026</h3>
                                </div>
                                <div className="self-stretch px-2.5 inline-flex justify-center sm:justify-end items-center gap-2.5">
                                    <p className="flex-1 text-center sm:text-right justify-start text-black group-hover:text-white text-sm sm:text-base leading-6 sm:leading-7 transition-colors duration-300">1 days,  In-Person</p>
                                </div>
                            </div>
                        </div>
                        <div className="w-full text-black group-hover:text-white transition-colors duration-300 text-[clamp(1.5rem,4vw,2.5rem)] sm:text-3xl lg:text-[27px] lg:leading-[39px] lg:tracking-[0px]">
                            <h3 className="block lg:hidden text-center">
                                Connect. Learn. <br />Collaborate
                            </h3>
                            <h3 className="hidden lg:block lg:text-left lg:whitespace-nowrap">
                                Connect. Learn. Collaborate
                            </h3>
                        </div>
                        <p className="self-stretch text-center sm:text-left justify-start text-black group-hover:text-white text-sm sm:text-base leading-6 sm:leading-7 transition-colors duration-300">A day of keynotes, panels and networking focusing on blockchain adoption, developer tooling and ecosystem growth across Africa.</p>
                        <div className="self-stretch flex flex-col justify-start items-start gap-5">
                            ...
                            <div className="self-stretch flex flex-col sm:flex-row justify-start items-start sm:items-center gap-3">
                                <div className="flex-1 inline-flex flex-col justify-start items-center w-full">
                                    <div className="px-2.5 flex justify-center items-center gap-2.5 w-full">
                                        <h4 className="text-left justify-start text-black group-hover:text-white text-base sm:text-lg leading-5 sm:leading-6 transition-colors duration-300">
                                            Speakers • Panels • Networking
                                        </h4>
                                    </div>
                                    <div className="self-stretch px-2.5 inline-flex justify-center items-center gap-2.5 w-full">
                                        <p className="flex-1 text-center text-black group-hover:text-white text-xs sm:text-sm leading-6 sm:leading-7 transition-colors duration-300">
                                            Industry leaders & ecosystem founders
                                        </p>
                                    </div>
                                </div>
                                {/*<div className="w-full sm:w-auto flex justify-center">*/}
