     ...
     <div
        ...
        >
            ...
            <div className="relative z-10 max-w-4xl">
                <p className="mb-3 text-sm font-medium font-poppins tracking-widest text-gray-300 md:text-base text-center">
                    February 11–13 • Nairobi, Kenya
                </p>

                <h1 className="font-telegraf font-extrabold mb-0 text-white text-[40px] leading-[44px] md:text-[80px] md:leading-[66px] text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4 mt-2">
          ...
          >
            <span className="font-telegraf font-extrabold text-[16px] leading-[20px] tracking-[-0.01em] text-[#7FB843] group-hover:text-white transition-colors duration-150">
               Become a Partner
             </span>
           </button>
